...
def create_first_test_vlsege16(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
    ...
    generate_macros_vlseg(f, lmul, vsew, 16)

    # Generate tests
    (n, rnd) = generate_tests_vlseg(f, rs1_val, rs2_val, lmul, vsew, 16)

    # Common const information

    # Load const information
    print_load_ending(f, 16, n, seg = rnd)
